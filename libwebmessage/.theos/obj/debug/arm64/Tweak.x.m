...
@class IMHandle; @class CKConversationList; @class IMMessage; @class NSNotificationCenter; @class CKMediaObjectManager; @class CKComposition; @class IMChatRegistry; @class IMDaemonController; @class IMAccountController; 
