...
@class NSNotificationCenter; @class IMDaemonController; @class CKMediaObjectManager; @class IMChatRegistry; @class CKComposition; @class IMMessage; @class IMHandle; @class CKConversationList; @class IMAccountController; 
